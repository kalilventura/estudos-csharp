...
namespace Store.Tests.Entities
{
    ...
    public class OrderTests
    {
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_um_desconto_expirado_sem_frete_o_valor_do_pedido_deve_ser_60()
        {
            var expiredDiscount = new Discount(10, new DateTime(2015, 01, 01));
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_um_desconto_expirado_com_frete_o_valor_do_pedido_deve_ser_60()
        {
            var expiredDiscount = new Discount(10, new DateTime(2015, 01, 01));
